...
namespace WsComercialApp.Repositorio
{
    public class RepositorioCO_Pedido
    {
        ...
        internal List<Model_CO_DocumentoDetalle> getComentariosDetalleLetras(Model_CO_Documento request)
        {
            ...
            String queryArmado = " select trim(Estado) as Estado, 'BASEDATOS' AS Origen ,CompaniaSocio,CONVERT(varchar, OperacionCanjeNumero) as NumeroDocumento , Secuencia as Linea , Comentario from CO_OperacionCanjeComentario " +
